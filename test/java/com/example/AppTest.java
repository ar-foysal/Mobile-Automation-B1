...
/**
 * Test class for automating interactions with the General Store sample Android
 * application.
 * It demonstrates basic Appium setup, UI Automator capabilities configuration,
 * and simple UI element interactions.
 */
public class AppTest {
    ...
    public void setUp() {
        ...
        if (!f.exists()) {
            f = new File("mobileb1/src/test/resources");
        }
        File generalStorApk = new File(f, "General-Store.apk");
        ...
        Capabilities options = new BaseOptions()
                ...
                .amend("appium:app", generalStorApk.getAbsolutePath())
